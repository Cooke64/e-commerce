# Generated by Django 3.2.12 on 2022-04-02 09:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=250, verbose_name='Название')),
                ('color', models.CharField(blank=True, choices=[(1, 'Желтый'), (2, 'Красный'), (3, 'Синий'), (4, 'Черный'), (5, 'Золотой')], max_length=250, verbose_name='Цвет')),
                ...
                ('like', models.ManyToManyField(related_name='products', to='product.Likes')),
